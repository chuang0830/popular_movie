...
const Index = () => {
  ...
  const { vote_average, title, name, overview, backdrop_path } =
    trending.trending;
  useEffect(() => {
        ...
        <>
          ...
          <div className="container">
            <div className="list_container">
              <div className="list_title">Popular English Movie</div>
              <div className="list_wrap">
                {movies &&
                  movies.length &&
                  movies.map((value) => {
                    return (
                      value.original_language === "en" && (
            ...
            <div className="list_container">
              <div className="list_title">Popular Foreign Language Movie</div>
              <div className="list_wrap">
                {movies &&
                  movies.length &&
                  movies.map((value) => {
            ...
            <div className="list_container">
              <div className="list_title">Popular English TV show</div>
              <div className="list_wrap">
                {tvs &&
                  tvs.length &&
                  tvs.map((value) => {
            ...
            <div className="list_container">
              <div className="list_title">Popular Foreign Language TV show</div>
              <div className="list_wrap">
                {tvs &&
                  tvs.length &&
                  tvs.map((value) => {
